...
function Navbar() {
  ...
  return (
    <div className="w-full px-4 py-4 relative z-10">
      <div className="max-w-7xl mx-auto">
        <div className="rounded-full px-[1.5rem] py-[1.5rem">
          <nav className="flex justify-between items-center px-[.5rem]">
            ...
            <div className="hidden md:flex items-center gap-4 border-[0.8px] rounded-full border-[#c7f9cc]  px-4 py-2">
              <Link
                to={"/"}
                className="text-white/70 hover:text-white text-[.5rem] transition-colors"
              >
                Home
              </Link>
              <Link
                to={"/about"}
                className="text-white/70 hover:text-white transition-colors text-[.5rem]"
              >
                About
              </Link>
              <Link
            ...
            <Link
              to={"/download"}
              className="hidden md:block bg-[#c7f9cc] text-[.5rem] text-[#000] hover:bg-[#fff] hover:text-[#1d351f] rounded-full px-4 py-2 font-normal transition-colors "
            >
              Download
            </Link>
            <button
      ...
      <div
        className={`md:hidden absolute top-full left-0 right-0 p-4 z-50 transition-all duration-300 ease-in-out flex flex-col gap-4 ${
          isMenuOpen
